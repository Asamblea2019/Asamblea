<%-- 
    ...
    Document   : Estilofin
    Created on : 29/08/2019, 02:22:08 PM
...
<%  
    ...
    if ( miSession.getAttribute("usuario")!= null) {
          user = (UsuarioVO) miSession.getAttribute("usuario");
          
        }
   String rol=user.getTipo_usu();
%>
                  ...
                  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav"
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                               <a class="dropdown-item" href="InicioSesion.jsp" name="Salir" <%miSession.invalidate();%>>Cerrar Sesion</a>
            ...
            <div class="col-lg-5 offset-lg-1 col-sm-8 offset-sm-2">
               <div class="banner_text aling-items-center">
                  <div class="banner_text_iner">
                     <h5>Total Quorum</h5>
                     <h2>Propiedades <br>
                        ahora en conjuntos</h2>
                     <p> La especiacial de agilizar los procesos de una asamblea es nuestra prioridad</p>
...
<%
    if (request.getParameter("Salir")!=null) {
            session.invalidate();
            response.sendRedirect("InicioSesion.jps");
        }
%>
</html>
