<%-- 
    Document   : actualizar_constituyente
    Created on : 28/08/2019, 01:10:01 AM
...
<form method="post" action="Estilofin.jsp">
      ...
      <div class="container">
	   ...
	   <center>
        <h1>Actualizar Constituyente</h1>
        <form method="post" action="Constituyente">
            <% 
                ConstituyenteVO constVO = (ConstituyenteVO)request.getAttribute("voLLeno");
                if(constVO !=null){
            ...
            <table border="1">
                  <tr>
                      <td>Cedula Constituyente</td>
                      <td><input type="text" name="select" value="<%= constVO.getCedulaf_Usuario()%>" readonly=""></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                      <td>Nombre</td>
                      <td><input type="text" name="txtnombre_Constituyete" value="<%= constVO.getNombre_Constituyete()%>" required pattern="[A-Za-z ]+"  maxlength="20" autofocus=""></td>
                  </tr>
                  <tr>
                      <td>Apellido</td>
                      <td><input type="text" name="txtapellido_Constituyente" value="<%= constVO.getApellido_Constituyente()%>" required pattern="[A-Za-z ]+"  maxlength="20" ></td>
                  </tr>
                  <tr>
                      <td>Correo</td>
                      <td><input type="text" name="txtcorreo_Constituyente" value="<%= constVO.getCorreo_Constituyente()%>" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}"></td>
                  </tr>
                  <tr>
                      <td>Celular</td>
                      <td><input type="text" name="txtcel_Constituyente" value="<%= constVO.getCel_Constituyente()%>"  pattern="[0-9 ]+" minlength="7" maxlength="15"></td>
                  </tr>
                  
                   <td>Estado Constituyente</td>
                   <td><select name="txtestado" class="form-control" value="<%= constVO.getEstado_Constituyenye()%>">
        ...
        <a href="consultar_constituyente.jsp" value="2">Atras</a>
