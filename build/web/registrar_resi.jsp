        ...
        <section class="banner_part">
            ...
            <div class="container" >
                ...
                <div id="Contenedor-form">   
                    ...
                    <form method="post" action="Resi" class="needs-validation" novalidate="">




                        <label>Constituyente</label><br>
                        ...
                        <label for="validationCustom01">Apartamento</label><br>
                        <input class="form-control" id="validationCustom01" type="text" placeholder="Torre 1 apt 203" name="apartamento" required maxlength="100" autofocus=""><br>
                                ...
                                <a class="btn btn-outline-primary" href="consultar_resi.jsp">Consultar</a>
