        ...
        <center>
            ...
            <form method="post" action="Temas">
                <table class="table">
                    <tr>
                        <th>
                            Numero de tema<br><br>
                            
                            <select name="txtid_tema" class="form-control" >
                            <%
            ...
            <a href="Registrar_tema.jsp">Atrás</a>
            ...
            <form>
                <table class="table">
                    ...
                    <%
                        ...
                        ArrayList<TemasVO> listaConstituyentes = temDAO.listar();
                        

                        for (int i = 0; i < listaConstituyentes.size(); i++) {
                            
                            temVO = listaConstituyentes.get(i);
                    %>
                    
                    <tr>
                        <th scope="row"><%= temVO.getId_Tema()%></th>
                        <td><%= temVO.getIdf_Asamblea()%></td>
                        <td><%= temVO.getTema()%></td>
                        <td><%= temVO.getEstado_tema()%></td>
