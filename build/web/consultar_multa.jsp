<%-- 
    Document   : consultar_multa
    Created on : 27/08/2019, 01:43:09 AM
    Author     : Mateo Coronado
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="TemasDAO.MultaDAO"%>
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <body>
	  ...
	  <center>
            ...
            <form method="post" action="Multa">
                <table class="table">
                    <tr>
                        <th>
                            Multa<br><br>
                            <input type="text" name="txtIdMulta" required="">
                        </th>
                    </tr>
                </table><br>
            ...
            <a href="Registrar_multa.jsp">Atrás</a>
            ...
            <form>
                <table class="table">
                    <tr>
                        ...
                        <th scope="col">ESTADO MULTA</th>
                        
                    </tr>
                    
                    <%
                        MultaVO multVO = new MultaVO();
                        MultaDAO multDAO = new MultaDAO();
                        
                        ArrayList<MultaVO> listaMulta = multDAO.listar();
                        

                        for (int i = 0; i < listaMulta.size(); i++) {
                            
                            multVO = listaMulta.get(i);
                    %>
                    
                    <tr>
                        <th scope="row"><%= multVO.getId_multa()%></th>
                        <td><%= multVO.getIdf_asistencia()%></td>
                        <td><%= multVO.getCedulaf_constituyente()%></td>
                        <td><%= multVO.getDescripcion_multa()%></td>
                        <td><%= multVO.getPago_multa()%></td>
                        <td><%= multVO.getFecha_multa()%></td>
                        <td><%= multVO.getFecha_pago()%></td>
                        <td><%= multVO.getEstado_multa()%></td>
                    </tr>
