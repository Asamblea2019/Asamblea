<%-- 
    Document   : registrar_pregunta
    Created on : 28/08/2019, 02:13:42 AM
        ...
        <section class="banner_part">
            ...
            <div class="container" style="width: 45%">
                <div id="Contenedor-form">  
                    ...
                    <center>
                        <H1>Registro De Pregunta</H1>

                        <form method="post" action="Pregunta" class="needs-validation" novalidate="">
                            ...
                            <select name="select" class="form-control"  >
                                <%
                                    VotosVO voVO = new VotosVO();
                                    VotosDAO voDAO = new VotosDAO();

                                    ArrayList<VotosVO> listaVotos = voDAO.listarTema();

                                    for (int i = 0; i < listaVotos.size(); i++) {

                                        voVO = listaVotos.get(i);
                                %>

                                <option value="<%= voVO.getId_Votacion()%>"><%= voVO.getTipo_Votacion()%></option>
                            ...
                            <lable for="validationCustom01">Pregunta</lable>
                            <input class="form-control" id="validationCustom01" type="text" placeholder="¿Pregunta?" name="txtPregunta" required="" pattern="[A-Za-z ]+"  maxlength="300"><br>
