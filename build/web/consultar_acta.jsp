<%-- 
    Document   : consultar_acta
    Created on : 28/09/2019, 12:46:05 PM
    Author     : fugo5
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="java.util.ArrayList"%>
<%@page import="TemasDAO.ActaDAO"%>
<%@page import="TemasVO.ActaVO"%>
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <body>
      ...
      <div class="container">
	   ...
	   <center>
            <h1>ACTA</h1><br>
            <form method="post" action="Acta">
                <table class="table">
                    <tr>
                        <th>
                            ID ACTA<br><br>
                            <input type="text" name="txtid_acta" required="">
                        </th>
                    </tr>
                </table><br>
            ...
            <a href="Registrar_acta.jsp">Atrás</a><br><br>
            ...
            <form id="Table"> 
                ...
                <table class="table">
                    <tr>
                        <th scope="col">NUMERO ACTA</th>
                        <th scope="col">FECHA INFORME</th>
                        <th scope="col">DESCRIPCIÓN ACTA</th>
                        <th scope="col">REGISTRO ACTA</th>
                    ...
                    <%
                        ActaVO actVO = new ActaVO();
                        ActaDAO actDAO = new ActaDAO();
                        
                        ArrayList<ActaVO> listaacta = actDAO.listar();
                        

                        for (int i = 0; i < listaacta.size(); i++) {
                            
                            actVO = listaacta.get(i);
                    %>
                    
                    <tr>
                        <th scope="row"><%= actVO.getId_acta()%></th>
                        <td><%= actVO.getIdf_informe()%></td>
                        <td><%= actVO.getDescripcion_acta()%></td>
                        <td><%= actVO.getRegistro_acta()%></td>
                        <td><%= actVO.getFecha_acta()%></td>
                        <td><%= actVO.getEstado_acta()%></td>
                    </tr>
