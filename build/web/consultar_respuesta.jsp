<%-- 
    Document   : consultar_pregunta
    Created on : 28/08/2019, 02:17:50 AM
    Author     : Mateo Coronado
--%>
<%@page import="TemasDAO.RespuestaDAO"%>
<%@page import="TemasVO.RespuestaVO"%>
...
<html>
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	...
	<center>
            <h1>Votacion Consejo </h1><br>
            
            
            <a href="tema.jsp">Atrás</a>
            ...
            <form>
                <table class="table">
                    ...
                    <%
                        ...
                        RespuestaVO resVOF = new RespuestaVO();
                        RespuestaVO resVOC = new RespuestaVO();
                        RespuestaVO resVOCn = new RespuestaVO();
                        RespuestaDAO resDAO = new RespuestaDAO();
                        
                        ArrayList<RespuestaVO> listaPresguntas = resDAO.listar();
                        ArrayList<RespuestaVO> listaFavor = resDAO.listarSi();
                        ArrayList<RespuestaVO> listaContra = resDAO.listarNo();
                        ArrayList<RespuestaVO> listaContar = resDAO.contar();
                        

                        for (int i = 0; i < listaPresguntas.size(); i++) {
                            
                                
                            
                            resVO = listaPresguntas.get(i);
                    ...
                    <tr>
                        <th scope="row"><%= resVO.getResRespuesta()%></th>
                        <%
                            for (int j = 0; j < listaContar.size(); j++) {
                            resVOCn = listaContar.get(j);
                            resVOF = listaFavor.get(j);
                            resVOC = listaContra.get(j);
                            
                        %>
                        <td><%= resVOCn.getResIdfPregunta()%></td>
                        <td><%= resVOF.getResEstado()%></td>
                        <td><%= resVOC.getResRespuesta()%></td>
            ...
            <h1>Votacion Administrativa </h1><br>
            ...
            <form>
                <table class="table">
                    ...
                    <%
                        RespuestaVO resVOADMI = new RespuestaVO();
                        //RespuestaVO resVOF = new RespuestaVO();
                        //RespuestaVO resVOC = new RespuestaVO();
                        RespuestaDAO resDAOADMI = new RespuestaDAO();
                        
                        ArrayList<RespuestaVO> listaAdmi = resDAOADMI.listarAdmi();
                        //ArrayList<RespuestaVO> listaFavor = resDAO.listarSi();
                        //ArrayList<RespuestaVO> listaContra = resDAO.listarNo();
                        ...
                        for (int i = 0; i < listaAdmi.size(); i++) {
                            ...
                            resVOADMI = listaAdmi.get(i);
                            /*resVOADMI = listaFavor.get(i);
                            resVOADMI = listaContra.get(i);*/
                            
                    %>
                    
                    <tr>
                        <th scope="row"><%= resVOADMI.getResRespuesta()%></th>
                        
                        <td><%= resVOADMI.getResIdfPregunta()%></td>
