<%-- 
    Document   : registrar_votos
    Created on : 26/08/2019, 07:57:24 PM
    Author     : mp4ma
--%>
        ...
        <section class="banner_part">
            ...
            <div class="container" style="width: 45%">
                <div id="Contenedor-form">  
                    ...
                    <H1>Registro Tipo de votación</H1>

                    <form method="post" action="Votos" class="needs-validation" novalidate="" >
                        ...
                        <select name="select" class="form-control" >
                            ...
                            <option value="<%= temVO.getId_Tema()%>"><%= temVO.getTema()%></option>
                        ...
                        <lable>Tipo de Votación</lable>
                        <select class="form-control" name="texttipo_Votacion" pattern="[A-Za-z ]+"  maxlength="18">
                    ...
                    <a href="registrar_pregunta.jsp" class="btn btn-outline-primary">Siguiente</a>
