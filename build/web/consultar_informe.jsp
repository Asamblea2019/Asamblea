      ...
      <div class="container">
	   ...
	   <center>
            ...
            <form method="post" action="Informe">
                <table class="table">
                    <tr>
                        <th>
                            ID INFORME<br><br>
                            <input type="text" name="txtInforme" required="">
                        </th>
                    </tr>
                </table><br>
            ...
            <form id="Table"> 
                ...
                <table class="table">
                    <tr>
                        <th scope="col">NUMERO INFORME</th>
                        <th scope="col">FECHA ASAMBLEA</th>
