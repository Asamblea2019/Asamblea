                        ...
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                               <a class="dropdown-item" href="InicioSesion.jsp" name="Salir" <%session.invalidate();%>>Cerrar Sesion</a>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="registrar_asistencia.jsp" id="navbarDropdown" role="button"
                                           >
                                            Empezar asamblea
                                        </a>
            ...
            <div class="container">
                <div id="Contenedor-form">   
                    ...
                    <center>
                        ...
                        <form method="post" action="Asamblea" class="needs-validation" novalidate=""> 		

                            <div id="Contenedor">  
                                <label>TIPO DE ASAMBLEA</label><br><br>
                                <select name="tipo_Asamblea" class="form-control">
                                ...
                                <label for="validationCustom01">FECHA DE ASAMBLEA</label><br><br>
                                <input class="form-control" id="validationCustom01" type="date" placeholder="03/09/2019" name="fecha_Asamblea" required="" min="2019-11-30" max="2020-12-31"><br><br>
                            </div>
                            <div id="Contenedor" >  
                                <label for="validationCustom02">DESCRIPCIÓN DE ASAMBLEA</label><br><br>
                                <textarea class="form-control"  id="validationCustom02" rows="3" style="height: 150px" name="descripcion_Asamblea" required="" pattern="[A-Za-z ]+"  maxlength="300"></textarea>
                            ...
                            <div id="Contenedor">  
                                ...
                                <div id="Botones" >
                                <div>
                                    <br><button  class="btn btn-outline-primary">Registrar</button></div><br>
                                <input type="hidden" name="opcion" value="1">
                            </div></div><br>
                        </form> 

                        <form action="">
                            <button type="button" class="btn btn-outline-primary" href="Estilofin.jsp">Menu </button>       
                        </form>
