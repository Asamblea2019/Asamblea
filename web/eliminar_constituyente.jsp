            ...
            <form method="post" action="Constituyente">
                <table border="1">
                    <tr>
                        <th>
                            Cedula<br><br>
                            <input type="text" name="txcedula_Constituyente.">
                        </th>
                    </tr>
                </table><br>
            ...
            <form id="Table"> 
                ...
                <table border="1">
                    ...
                    <%
                        ...
                        ArrayList<ConstituyenteVO> listaConstituyentes = constDAO.listar();
                    ...
                    <tr>
                        <td><%= constVO.getCedula_Constituyente()%></td>
                        <td><%= constVO.getCedulaf_Usuario()%></td>
                        ...
                        <td><%= constVO.getResidencia_Constituyente()%></td>
                    </tr>
