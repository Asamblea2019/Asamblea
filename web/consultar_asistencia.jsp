...
<section class="banner_part">
    ...
    <div class="container" >
	  ...
	  <center>
            ...
            <a href="registrar_asistencia.jsp">Atrás</a><br>
            <a href="../src/java/TemasControlador/ControladorTemas.java"></a><br>
            <form>
                <table class="table">
                    <tr>
                        <th scope="col">NUMERO DE ASISTENCIA</th>
                        <th scope="col">FECHA DE ASAMBLEA</th>
                        <th scope="col">CEDULA CONSTITUYENTE</th>
                    ...
                    <%
                        AsistenciaVO asisVO = new AsistenciaVO();
                                    ...
                                    for (int i = 0; i < listaAsis.size(); i++) {
                                        ...
                                        asisVO = listaAsis.get(i);
                    %>
                    
                    <tr>
                        <th scope="row"><%= asisVO.getId_asistencia()%></th>
                        <td><%= asisVO.getIdf_asamblea()%></td>
                        <td><%= asisVO.getCedulaf_Constituyente()%></td>
