<%-- 
    Document   : registrar_acta
    Created on : 28/09/2019, 12:04:36 PM
    Author     : fugo5
--%>
            ...
            <div class="container">
                <div id="Contenedor-form">   
                    ...
                    <center>
                        ...
                        <form method="post" action="Acta" class="needs-validation" novalidate=""> 		
                            ...
                            <div id="Contenedor">  
                                ...
                                <select name="select" class="form-control"  >
                                    <%
                                        ...
                                        InformeDAO infAO = new InformeDAO();

                                        ArrayList<InformeVO> listaInforme = infAO.listar();
                                    ...
                                    <option value="<%= infVO.getInId()%>"><%= infVO.getInFecha()%></option>
                                ...
                                <label for="validationCustom01">Descripción acta</label><br><br>
                                <input class="form-control" id="validationCustom01" type="text" placeholder="Nombre Informe" name="txtdescripcion_acta" required="" pattern="[A-Za-z ]+"  maxlength="125"><br><br>
                                <label for="validationCustom02">Registro acta</label><br>
                                <input class="form-control" id="validationCustom02" type="text" placeholder="Redactor" name="txtregistro_acta" required="" pattern="[A-Za-z ]+"  maxlength="300"><br><br>

                            </div>


                            <div id="Contenedor" style="width: 55%; float: right;">  
                                <label for="validationCustom03">FECHA ACTA</label><br><br>
                                <input class="form-control" id="validationCustom03" type="date"  name="txtfecha_acta" required=""><br><br>
