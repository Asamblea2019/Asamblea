   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    <body>
      ...
      <div class="container">
	   ...
	   <center>
            <h1>Eliminar Multa</h1><br>
            <form method="post" action="Multa">
                <table border="1">
                    <tr>
                        <th>
                            ID MULTA<br><br>
                            <input type="text" name="txtIdMulta">
                        </th>
                    </tr>
                </table><br>
            ...
            <form id="Table"> 
                ...
                <table border="1">
                    ...
                    <%
                        MultaVO mulVO = new MultaVO();
                        MultaDAO mulDAO = new MultaDAO();
                        
                        ArrayList<MultaVO> listaConstituyentes = mulDAO.listar();
                        

                        for (int i = 0; i < listaConstituyentes.size(); i++) {
                            
                            mulVO = listaConstituyentes.get(i);
                    %>
                    
                    <tr>
                        <td><%= mulVO.getId_multa()%></td>
                        <td><%= mulVO.getIdf_asistencia()%></td>
                        <td><%= mulVO.getCedulaf_constituyente()%></td>
                        <td><%= mulVO.getDescripcion_multa()%></td>
                        <td><%= mulVO.getPago_multa()%></td>
                        <td><%= mulVO.getFecha_multa()%></td>
                        <td><%= mulVO.getFecha_pago()%></td>
                    </tr>
