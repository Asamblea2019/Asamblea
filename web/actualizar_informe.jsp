      ...
      <div class="container">
	   ...
	   <center>
        ...
        <form method="post" action="Informe">
            <% 
                InformeVO infVO = (InformeVO)request.getAttribute("voLLeno");
                if(infVO !=null){
            ...
            <table border="1">
                  <tr>
                      <td>Id Informe</td>
                      <td><input type="text" name="txtInforme" value="<%= infVO.getInId()%>" readonly=""></td>
                  </tr>
                  <tr>
                      <td>Id Asamblea</td>
                      <td><input type="text" name="select" value="<%= infVO.getInIdfAsamblea()%>"></td>
                  </tr>
                  <tr>
                      <td>Nombre de Informe</td>
                      <td><input type="text" name="txtnombre_Informe" value="<%= infVO.getInNombre()%>"pattern="[A-Za-z ]+"  maxlength="25"></td>
                  </tr>
                  <tr>
                      <td>Redactor</td>
                      <td><input type="text" name="txtredactor_Informe" value="<%= infVO.getInRedactor()%>" pattern="[A-Za-z ]+"  maxlength="300"></td>
                  </tr>
                  <tr>
                      <td>Fecha</td>
                      <td><input type="text" name="txtfecha_Informe" value="<%= infVO.getInFecha()%>"></td>
                  </tr>
                  <tr>
                                    <td>Estado</td>
                                    <td>
        ...
        <a href="consultar_informe.jsp" value="2">Atras</a>
