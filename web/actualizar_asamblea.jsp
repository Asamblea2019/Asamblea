<%-- 
    Document   : actualizar_asamblea
    Created on : 4/09/2019, 12:21:27 AM
        ...
        <section class="banner_part">
            <div class="container">
                <div id="Contenedor-form">   
                    ...
                    <center>
                        <h1>Actualizar Asamblea</h1>
                        <form method="post" action="Asamblea">
                            <%
                                AsambleaVO asmVO = (AsambleaVO) request.getAttribute("voLLeno");
                                if (asmVO != null) {
                            ...
                            <table border="1">
                                <tr>
                                    ...
                                    <td><input type="text" name="id_Asamblea" value="<%= asmVO.getId_Asamblea()%>" required="" readonly=""></td>
                                </tr>
                                <tr>
                                    <td>Tipo de asamblea</td>
                                    <td>
                                        <select name="tipo_Asamblea" >
                                ...
                                <tr>
                                    <td>Fecha de Asamblea</td>
                                    <td><input type="text" name="fecha_Asamblea" value="<%= asmVO.getFecha_Asamblea()%>"></td>
                                </tr>
                                <tr>
                                    <td>Descripción</td>
                                    <td><input type="text" name="descripcion_Asamblea" value="<%= asmVO.getDescripcion_Asamblea()%>" maxlength="300" pattern="[A-Za-z ]+"></td>
                                </tr>
                                <tr>
                                    <td>Estado Asamblea</td>
                                    <td><select name="estado_Asamblea" class="form-control" value="<%= asmVO.getEstado_Asamblea()%>">
                        ...
                        <a href="consultar_Asamblea.jsp" value="2">Atras</a>
