<%-- 
    Document   : consultar_Asamblea
    Created on : 27/08/2019, 01:51:26 AM
	  ...
	  <center>
            ...
            <form method="post" action="Asamblea">
                <table class="table">
                    <tr>
                        <th>
                            Numero de Asamblea<br><br>
                            <select name="id_Asamblea" class="form-control"  >
            ...
            <a href="Registrar_Asamblea.jsp">Atrás</a><br>
            <a href="../src/java/TemasControlador/ControladorTemas.java"></a><br>
            <form>
                <table class="table">
                    <tr>
                         <th scope="col">NUMERO DE ASAMBLEA</th>
                        <th scope="col">TIPO DE ASAMBLEA </th>
                        <th scope="col">FECHA DE ASAMBLEA</th>
                        <th scope="col">DESCRIPCIÓN DE ASAMBLEA</th>
                        <th scope="col">ESTADO DE LA ASAMBLEA</th>
                    ...
                    <tr>
                        <th scope="row"><%= asmVO.getId_Asamblea()%></th>
                        <td><%= asmVO.getTipo_Asamblea()%></td>
                        <td><%= asmVO.getFecha_Asamblea()%></td>
                        <td><%= asmVO.getDescripcion_Asamblea()%></td>
                        <td><%= asmVO.getEstado_Asamblea()%></td>
