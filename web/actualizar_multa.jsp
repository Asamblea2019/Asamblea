<%-- 
    Document   : actualizar_multa
    Created on : 28/08/2019, 01:25:21 AM
    Author     : Mateo Coronado
--%>
<%@page import="TemasVO.MultaVO"%>
...
<html>
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	...
	<center>
        ...
        <form method="post" action="Multa">
            <% 
                MultaVO mulVO = (MultaVO)request.getAttribute("voLLeno");
                if(mulVO !=null){
            ...
            <table border="1">
                  <tr>
                      <td>Numero de multa</td>
                      <td><input type="text" name="txtIdMulta" value="<%= mulVO.getId_multa()%>" readonly=""></td>
                  </tr>
                  <tr>
                      <td>Numero de asistencia</td>
                      <td><input type="text" name="txtIdfAsistencia" value="<%= mulVO.getIdf_asistencia()%>"></td>
                  </tr>
                  <tr>
                      <td>Numero de cedula</td>
                      <td><input type="text" name="select" value="<%= mulVO.getCedulaf_constituyente()%>"></td>
                  </tr>
                  <tr>
                      <td>Descripción de multa</td>
                      <td><input type="text" name="txtDescripcionMulta" value="<%= mulVO.getDescripcion_multa()%>"  pattern="[A-Za-z ]+"  maxlength="125"></td>
                  </tr>
                  <tr>
                      <td>Total a pagar</td>
                      <td><input type="text" name="txtPagoMulta" value="<%= mulVO.getPago_multa()%>"  required=""></td>
                  </tr>
                  <tr>
                      <td>Fecha de multa</td>
                      <td><input type="text" name="datfecha_multa" value="<%= mulVO.getFecha_multa()%>"></td>
                  </tr>
                  <tr>
                      <td>Dia a pagar</td>
                      <td><input type="text" name="datfecha_pago" value="<%= mulVO.getFecha_pago()%>"></td>
                  </tr>
                  <tr>
                                    <td>Estado</td>
                                    <td>
        ...
        <a href="consultar_multa.jsp" value="2">Atras</a>
