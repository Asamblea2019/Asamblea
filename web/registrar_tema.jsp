<%-- 
    Document   : registrar_tema
    Created on : 27/08/2019, 01:15:37 AM
        ...
        <section class="banner_part">
            ...
            <div class="container" style="width: 45%">
                <div id="Contenedor-form">  
                    ...
                    <form method="post" action="Temas"  class="needs-validation" novalidate="">
                        ...
                        <lable for="validationCustom01">Tema a tratar</lable>
                        <input class="form-control" id="validationCustom01" type="text" placeholder="Tema" name="txttema_Asamblea" required="" pattern="[A-Za-z ]+"  maxlength="300"><br>
                        ...
                        <div id="Botones">
                            ...
                            <a href="registrar_votos.jsp" class="btn btn-outline-primary">Siguiente</a>
