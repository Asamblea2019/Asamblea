<%-- 
    Document   : actualizar_pregunta
    Created on : 28/08/2019, 02:21:44 AM
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	...
	<center>
        ...
        <form method="post" action="Pregunta">
            <% 
                PreguntaVO preVO = (PreguntaVO)request.getAttribute("voLLeno");
                if(preVO !=null){
            ...
            <table border="1">
                  <tr>
                      <td>Numero de pregunta</td>
                      <td><input type="text" name="txtid_Pregunta" value="<%= preVO.getId_pregunta()%>" readonly=""></td>
                  </tr>
                  <tr>
                      <td>Numero de votación</td>
                      <td><input type="text" name="select" value="<%= preVO.getIdf_votacion()%>"></td>
                  </tr>
                  <tr>
                      <td>Pregunta</td>
                      <td><input type="text" name="txtPregunta" value="<%= preVO.getPregunta()%>"></td>
                  </tr>
                  <tr>
                                    <td>Estado</td>
                                    <td>
        ...
        <a href="consultar_pregunta.jsp" value="2">Atras</a>
...
<script src="js/archivo.js"> </script>s        
