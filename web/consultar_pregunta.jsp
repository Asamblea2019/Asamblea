	...
	<center>
            ...
            <form method="post" action="Pregunta">
                <table class="table">
                    <tr>
                        <th>
                            Numero de pregunta<br><br>
                            <input type="text" name="txtid_Pregunta" required="">
                            <select name="id_Asamblea" class="form-control"  >
                             ...
                             <%
                                    ...
                                    <option value="<%= preVO.getId_pregunta()%>"><%= preVO.getPregunta()%></option>
            ...
            <a href="registrar_pregunta.jsp">Atrás</a>
            <a href="../src/java/TemasControlador/ControladorTemas.java"></a>
            <form>
                <table class="table">
                    <tr>
                        <th scope="col">NUMERO DE PREGUNTA</th>
                    ...
                    <tr>
                        <th scope="row"><%= preVO.getId_pregunta()%></th>
                        <td><%= preVO.getIdf_votacion()%></td>
                        <td><%= preVO.getPregunta()%></td>
                        <td><%= preVO.getEstado_pregunta()%></td>
