    ...
    <body>
      ...
      <div class="container">
        ...
        <form method="post" action="Resi">
            <% 
                ResidenciaVO resiVO = (ResidenciaVO)request.getAttribute("voLLeno");
                if(resiVO !=null){
            ...
            <table border="1">
                  <tr>
                      <td>Numero de residencia</td>
                      <td><input type="text" name="id_resi" value="<%= resiVO.getIdResi()%>" readonly=""></td>
                  </tr>
                  <tr>
                      <td>Cedula</td>
                      <td><input type="text" name="select" value="<%= resiVO.getCedulafConstituyente()%>" readonly=""></td>
                  </tr>
                  <tr>
                      <td>Apartamento</td>
                      <td><input type="text" name="apartamento" value="<%= resiVO.getApartamento()%>"   maxlength="300"></td>
                  </tr>
                  <tr>
                                    <td>Estado</td>
                                    <td>
        ...
        <a href="consultar_resi.jsp" value="2">Atras</a>
